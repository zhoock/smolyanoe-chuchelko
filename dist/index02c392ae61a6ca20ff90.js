...
const lang = getLang();
function useData(lang) {
    const [templateData, setTemplateData] = (0,react.useState)({
        templateA: [],
        templateB: [],
        templateC: [],
    }); // Хранение данных для  шаблонов
    const [loading, setLoading] = (0,react.useState)(false); // состояние для индикации загрузки
    const [error, setError] = (0,react.useState)(''); // состояние для хранения ошибок
    ...
    async function fetchData() {
        try {
            ...
            const [templateAResponse, templateBResponse, templateCResponse] = await Promise.all([
                lib_axios.get(`https://raw.githubusercontent.com/zhoock/smolyanoe-chuchelko/refs/heads/main/src/assets/albums-${lang}.json`),
                lib_axios.get(`https://raw.githubusercontent.com/zhoock/smolyanoe-chuchelko/refs/heads/main/src/assets/articles-${lang}.json`),
                lib_axios.get(`https://raw.githubusercontent.com/zhoock/smolyanoe-chuchelko/refs/heads/main/src/assets/${lang}.json`),
            ]);
 ...
 */
function getImageUrl(img, format = '.jpg') {
...
function Navigation({ onToggle }) {
    ...
    return (react.createElement("nav", { role: "navigation", className: `header__menu` },
        react.createElement("ul", { className: "header__links-list" },
            react.createElement("li", { className: "header__links-list-item" },
                react.createElement(NavLink, { to: "/albums", title: templateData.templateC[0]?.menu.albums, onClick: onToggle, className: ({ isActive }) => {
                        return isActive ? 'active' : '';
                    } }, templateData.templateC[0]?.menu.albums)),
            react.createElement("li", { className: "header__links-list-item" },
                react.createElement(NavLink, { to: "/aboutus", title: templateData.templateC[0]?.menu.theBand, onClick: onToggle, className: ({ isActive }) => {
                        return isActive ? 'active' : '';
                    } }, templateData.templateC[0]?.menu.theBand)),
            react.createElement("li", { className: "header__links-list-item" },
                react.createElement(NavLink, { to: "/articles", title: templateData.templateC[0]?.menu.articles, onClick: onToggle, className: ({ isActive }) => {
                        return isActive ? 'active' : '';
...
function Header() {
    const [theme, setTheme] = (0,react.useState)(() => localStorage.getItem('theme') ||
        (window.matchMedia('(prefers-color-scheme: dark)').matches
            ? 'dark'
            : 'light'));
    const [lang, setLangState] = (0,react.useState)(getLang());
    const [langOpen, setLangOpen] = (0,react.useState)(false);
    const langRef = (0,react.useRef)(null);
    // Применяем тему
    (0,react.useEffect)(() => {
    ...
    return (react.createElement("header", { className: "header" },
        react.createElement("div", { className: "wrapper header__wrapper" },
            react.createElement("div", { className: "lang-menu", ref: langRef },
                react.createElement("button", { className: "lang-current", onClick: () => setLangOpen(!langOpen), "aria-haspopup": "listbox", "aria-expanded": langOpen }, lang.toUpperCase()),
                langOpen && (react.createElement("ul", { className: "lang-list", role: "listbox" }, ['en', 'ru'].map((l) => (react.createElement("li", { key: l },
                    react.createElement("button", { className: `lang-option${lang === l ? ' active' : ''}`, onClick: () => changeLang(l), role: "option", "aria-selected": lang === l }, l.toUpperCase()))))))),
            react.createElement(Link, { className: "logo", to: "/" }, "Home"),
            react.createElement(Navigation, null),
            react.createElement("div", { className: "theme-toggler" },
                react.createElement("label", { className: "theme-toggler__label" },
                    react.createElement("input", { type: "checkbox", className: "theme-toggler__control", checked: theme === 'light', onChange: toggleTheme }),
...
function Footer() {
    ...
    const { lang } = useLang();
    const { templateData } = useData(lang);
    return (react.createElement("footer", { role: "contentinfo", className: "footer extra-background" },
        react.createElement("div", { className: "wrapper" },
            react.createElement("ul", { className: "social-networks-list" }, socialNetwork.map((item) => (react.createElement("li", { className: "social-networks-list__item", key: item.id },
                react.createElement("a", { className: `social-networks__link icon-${item.name}`, href: item.href, target: "_blank" },
                    react.createElement("span", { className: "visually-hidden" }, item.name)))))),
            react.createElement("ul", { className: "copyright-list" },
                react.createElement("li", { className: "copyright-list__item" },
                    react.createElement("small", null,
                        react.createElement("span", null, "\u00A9 2021\u20142025 \u0421\u043C\u043E\u043B\u044F\u043D\u043E\u0435 \u0447\u0443\u0447\u0435\u043B\u043A\u043E"))),
                react.createElement("li", null,
                    react.createElement("small", null,
                        react.createElement("a", { href: "mailto:feedback@smolyanoechuchelko.ru" }, templateData.templateC[0]?.titles.support)))))));
}

;// ./src/components/Albums/WrapperAlbumCover.tsx



function WrapperAlbumCover({ albumId, date, album, children, }) {
    return (react.createElement("div", { className: "albums__card" },
        react.createElement(Link, { to: `/albums/${albumId}` },
            children,
            react.createElement("div", { className: "albums__description" },
                album,
                react.createElement("time", { dateTime: date },
                    react.createElement("small", null, date?.slice(0, 4)))))));
}
...
onColorsExtracted) {
    ...
    (0,react.useEffect)(() => {
        if (!onColorsExtracted)
            return; // если нет onColorsExtracted, выход из эффекта
...
;// ./src/components/Albums/AlbumCover.tsx
 ...
 */
function AlbumCover({ img, fullName, size = 448, onColorsExtracted, // 👈 Теперь этот коллбек принимает оба цвета
 }) {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement("picture", { className: "album-cover", role: "img" },
            react.createElement("source", { className: "album-cover__source", srcSet: `${getImageUrl(img, `-${size}.webp`)} 1x, ${getImageUrl(img, `@2x-${size * 2}.webp`)} 2x, ${getImageUrl(img, `@3x-${size * 3}.webp`)} 3x`, type: "image/webp" }),
            react.createElement("source", { className: "album-cover__source", srcSet: `${getImageUrl(img, `-${size}.jpg`)} 1x, ${getImageUrl(img, `@2x-${size * 2}.jpg`)} 2x`, type: "image/jpeg" }),
            react.createElement("img", { ref: imgRef, className: "album-cover__image", loading: "lazy", src: getImageUrl(img), alt: `Обложка альбома ${fullName}`, onLoad: () => setIsLoaded(true) }))));
}
...
function ErrorMessage({ error }) {
    return react.createElement("h3", { className: "error" }, error);
}
...
function Albums() {
    ...
    return (react.createElement("section", { className: "albums main-background", "aria-label": "\u0411\u043B\u043E\u043A c \u0441\u0441\u044B\u043B\u043A\u0430\u043C\u0438 \u043D\u0430 \u0430\u043B\u044C\u0431\u043E\u043C\u044B \u0421\u043C\u043E\u043B\u044F\u043D\u043E\u0435 \u0447\u0443\u0447\u0435\u043B\u043A\u043E" },
        react.createElement("div", { className: "wrapper" },
            react.createElement("h2", null, templateData.templateC[0]?.titles.albums),
            loading && react.createElement(Loader, null),
            error && react.createElement(ErrorMessage, { error: error }),
            react.createElement("div", { className: "albums__list" }, templateData.templateA.map((album) => (react.createElement(WrapperAlbumCover, { key: album.albumId, ...album, date: album.release.date },
                react.createElement(AlbumCover, { ...album.cover, fullName: album.fullName }))))))));
}
...
function AboutUs() {
    ...
    const renderParagraph = (item, i) => {
        if (typeof item === 'string') {
            ...
            return (react.createElement("p", { key: i, className: "about__text" }, parts.map((part, index) => {
                if (part === '<23>') {
                    return (react.createElement(Link, { key: index, to: "/albums/23", className: "album-details__link" }, "23"));
                }
                else if (part === '<Смоляное чучелко>') {
                    return (react.createElement(Link, { key: index, to: "/albums/smolyanoechuchelko", className: "album-details__link" }, "\u0421\u043C\u043E\u043B\u044F\u043D\u043E\u0435 \u0447\u0443\u0447\u0435\u043B\u043A\u043E"));
                }
                else {
                    return part;
                }
            ...
            return (react.createElement("p", { key: i, className: "about__text" },
                item.text[0],
                ' ',
                react.createElement("a", { className: "album-details__link", href: item.link, target: "_blank", rel: "noopener noreferrer" }, item.text[1]),
                ' ',
                item.text[2]));
        }
    };
    return (react.createElement("section", { className: "about main-background" },
        react.createElement("div", { className: "wrapper" },
            react.createElement("h2", null, templateData.templateC[0]?.titles.theBand),
            react.createElement("div", { className: `about__content ${isExpanded ? 'about__content_active' : ''}` }, templateData.templateC[0]?.theBand.map(renderParagraph)),
            react.createElement("button", { className: "about__look-more", onClick: () => setIsExpanded((prev) => !prev), type: "button", "aria-expanded": isExpanded },
                react.createElement("span", { className: "first-word" }, templateData.templateC[0]?.buttons.show),
                react.createElement("span", null, isExpanded
                    ? templateData.templateC[0]?.buttons.less
                    : templateData.templateC[0]?.buttons.more),
                react.createElement("span", { className: "icon-ctrl", "aria-hidden": "true" })))));
}
 ...
 */
function WrapperArticle({ articleId, img, nameArticle, date, }) {
    const { lang } = useLang();
    // Подгружаем функции для выбранного языка
    const { formatDate } = formatDateInWords[lang];
    return (react.createElement("article", { className: "articles__card" },
        react.createElement(Link, { to: `/articles/${articleId}` },
            react.createElement("div", { className: "articles__picture", style: {
                    background: `no-repeat center/cover url(${getImageUrl(img)})`,
                } }),
            react.createElement("div", { className: "articles__description" },
                nameArticle,
                react.createElement("time", { dateTime: date },
                    react.createElement("small", null, formatDate(date)))))));
}
...
function Articles() {
    ...
    return (react.createElement("section", { className: "articles main-background", "aria-label": "\u0411\u043B\u043E\u043A c \u0441\u0441\u044B\u043B\u043A\u0430\u043C\u0438 \u043D\u0430 \u0441\u0442\u0430\u0442\u044C\u0438 \u0421\u043C\u043E\u043B\u044F\u043D\u043E\u0435 \u0447\u0443\u0447\u0435\u043B\u043A\u043E" },
        react.createElement("div", { className: "wrapper articles__wrapper" },
            react.createElement("h2", null, templateData.templateC[0]?.titles.articles),
            react.createElement("div", { className: "articles__list" }, templateData.templateB.map((_) => (react.createElement(WrapperArticle, { key: _.articleId, ..._ })))))));
}
...
function Article() {
    ...
    const { formatDate } = formatDateInWords[lang];
    const { templateData, loading, error } = useData(lang);
    const params = useParams(); // возвращает все параметры, доступные на этой странице
    const article = templateData.templateB.find((_) => _.articleId === params.articleId);
    function Block({ title, subtitle, strong, content, img, alt, }) {
        return (react.createElement(react.Fragment, null,
            title && react.createElement("h3", null, title),
            react.createElement("div", { className: "uncollapse" }, img && react.createElement("img", { src: getImageUrl(img), alt: alt })),
            subtitle && react.createElement("h4", null, subtitle),
            typeof content == 'string' ? (react.createElement("p", null,
                strong && react.createElement("strong", null, strong),
                " ",
                content && content)) : (react.createElement("ul", null, content?.map((item, i) => react.createElement("li", { key: i }, item))))));
    }
    return (react.createElement("section", { className: "article main-background", "aria-label": "\u0411\u043B\u043E\u043A c\u043E \u0441\u0442\u0430\u0442\u044C\u0451\u0439" },
        react.createElement("div", { className: "wrapper" },
            react.createElement("nav", { "aria-label": "Breadcrumb", className: "breadcrumb" },
                react.createElement("ul", null,
                    react.createElement("li", null,
                        react.createElement(Link, { to: "/articles" }, templateData.templateC[0]?.titles.articles)),
                    react.createElement("li", { className: "active" }, article?.nameArticle))),
            loading && react.createElement(Loader, null),
            error && react.createElement(ErrorMessage, { error: error }),
            article && (react.createElement(react.Fragment, null,
                react.createElement("time", { dateTime: article.date },
                    react.createElement("small", null,
                        formatDate(article.date),
                        " \u0433.")),
                react.createElement("h2", null, article.nameArticle),
                article.detales.map((_) => (react.createElement(Block, { key: _.id, ..._ }))))))));
}
...
const functionsMap = {
    ru: {
        endForTracks: (n) => n === 1 ? 'трек' : n > 1 && n < 5 ? 'трека' : 'треков',
        endForMinutes: (n) => n === 1 ? 'минута' : n > 1 && n < 5 ? 'минуты' : 'минут',
    },
    en: {
        endForTracks: (n) => (n === 1 ? 'track' : 'tracks'),
        endForMinutes: (n) => n === 1 ? 'minute' : 'minutes',
    },
};
 ...
 */
function AlbumDetailsReleased({ album }) {
    const { lang } = useLang();
    // Подгружаем функции для выбранного языка
    ...
    function Block({ date, UPC }) {
        return (react.createElement(react.Fragment, null,
            react.createElement("time", { className: "album-details__released-time", dateTime: date }, formatDate(date)),
            react.createElement("div", null,
                react.createElement("small", null,
                    "UPC: ",
                    UPC)),
            react.createElement("div", null,
                react.createElement("small", null,
                    album?.tracks.length,
                    " ",
                    endForTracks(album?.tracks.length),
                    ",",
                    ' ',
                    Math.ceil(duration),
                    " ",
    ...
    return react.createElement(Block, { ...album?.release });
}
 ...
 */
function AlbumDetailsArtwork({ album }) {
    function Block({ photographer, photographerURL, designerURL, designer, }) {
        const { lang } = useLang();
        const { templateData } = useData(lang);
        return (react.createElement(react.Fragment, null,
            photographer && (react.createElement(react.Fragment, null,
                react.createElement("h3", null, templateData.templateC[0]?.titles.photo),
                react.createElement("div", { className: "album-details__artwork-photographer" },
                    react.createElement("a", { className: "album-details__link", href: photographerURL, target: "_blank" }, photographer)))),
            react.createElement("h3", null, templateData.templateC[0]?.titles.design),
            react.createElement("div", { className: "album-details__artwork-designer" }, designerURL ? (react.createElement("a", { className: "album-details__link", href: designerURL }, designer)) : (designer))));
    }
 ...
 */
function AlbumDetailsMusic({ album }) {
    function Block({ title, content }) {
        return (react.createElement(react.Fragment, null,
            react.createElement("h3", null, title),
            react.createElement("ul", null, content.map((item, i) => typeof item === 'string' ? (react.createElement("li", { key: i }, item)) : (react.createElement("li", { key: i },
                item.text[0],
                ' ',
                react.createElement("a", { className: "album-details__link", href: item.link, target: "_blank", rel: "noopener noreferrer" }, item.text[1]),
                item.text[2]))))));
    }
    return album?.detales.map((detail) => react.createElement(Block, { ...detail, key: detail.id }));
}
...
function AlbumDetails({ album }) {
    const { lang } = useLang();
    const { templateData } = useData(lang);
    function Block({ music, release, albumCover }) {
        return (react.createElement("section", { className: "album-details nested-background" },
            react.createElement("hr", null),
            react.createElement("div", { className: "wrapper album__wrapper" },
                react.createElement("div", { className: "item" },
                    react.createElement("div", { className: "album-details__music" },
                        react.createElement("h2", null, music),
                        react.createElement(AlbumDetailsMusic, { album: album }))),
                react.createElement("div", { className: "item item-release" },
                    react.createElement("div", { className: "album-details__released" },
                        react.createElement("h2", null, release),
                        react.createElement(AlbumDetailsReleased, { album: album }),
                        react.createElement("hr", null)),
                    react.createElement("div", { className: "album-details__artwork" },
                        react.createElement("h2", null, albumCover),
                        react.createElement(AlbumDetailsArtwork, { album: album }),
                        react.createElement("hr", null))))));
    }
    // оператор расширения или распространения (spread-оператор) ...
    return react.createElement(Block, { ...templateData.templateC[0]?.titles });
}

;// ./src/components/Popup/Popup.tsx


function Popup({ children, isActive, bgColor, onClose, }) {
    ...
    return (react.createElement("dialog", { ref: dialogRef, style: { background: bgColor } },
        react.createElement("div", { className: "popup__gradient", style: { background: bgColor } }),
        children));
}
 ...
 */
function Hamburger({ isActive, onToggle, zIndex, }) {
    return (react.createElement("button", { className: `hamburger ${isActive ? 'active' : ''}`, onClick: onToggle, style: { zIndex }, type: "button" },
        react.createElement("span", { className: "one" }),
        react.createElement("span", { className: "two" }),
        react.createElement("span", { className: "three" }),
        react.createElement("span", { className: "visually-hidden" }, !isActive ? 'Открыть меню' : 'Скрыть меню')));
}
...
function AudioPlayer({ album, autoPlay = false, setBgColor, }) {
    const [currentTrackIndex, setCurrentTrackIndex] = (0,react.useState)(0); // индекс текущего трека (начинается с 0)
    const [isPlaying, setIsPlaying] = (0,react.useState)(autoPlay); // флаг, указывающий, играет ли трек (изначально false)
    const [progress, setProgress] = (0,react.useState)(0); // прогресс трека в процентах (0-100)
    const [volume, setVolume] = (0,react.useState)(50); // уровень громкости (по умолчанию 50%)
    const [isSeeking, setIsSeeking] = (0,react.useState)(false); // указывает, выполняет ли пользователь перемотку
    const [time, setTime] = (0,react.useState)({ current: 0, duration: NaN }); // объект с текущим временем и общей длительностью трека
    const audioRef = (0,react.useRef)(null); // ссылка на элемент <audio>, чтобы управлять его состоянием (играет, ставится на паузу и т. д.)
    const latestTimeRef = (0,react.useRef)({ current: 0, duration: 1 }); // используется для хранения времени воспроизведения без вызова перерисовки компонента
    ...
    (0,react.useEffect)(() => {
        ...
        const updateProgress = () => {
            ...
            const progressBar = document.querySelector('.player__progress-bar input');
            if (progressBar) {
    ...
    const handleColorsExtracted = (0,react.useCallback)(({ dominant, palette }) => {
        setBgColor(`linear-gradient(var(--rotate, 132deg), ${dominant}, ${palette[6] || dominant})`);
    }, [setBgColor]);
    // Отображение
    return (react.createElement("div", { className: "player" },
        react.createElement(AlbumCover, { ...album.cover, fullName: album.fullName, onColorsExtracted: handleColorsExtracted }),
        react.createElement("div", { className: "player__track-info" },
            react.createElement("h2", null, album.tracks[currentTrackIndex]?.title || 'Unknown Track'),
            react.createElement("h3", null, album.artist || 'Unknown Artist')),
        react.createElement("div", { className: "player__progress-container" },
            react.createElement("div", { className: "player__progress-bar" },
                react.createElement("input", { type: "range", value: progress, min: "0", max: "100", onChange: handleProgressChange, onMouseUp: handleSeekEnd, onTouchEnd: handleSeekEnd })),
            react.createElement("div", { className: "player__time-container" },
                react.createElement("span", { className: "player__time" }, formatTime(time.current)),
                react.createElement("span", { className: "player__time" },
                    "-",
                    formatTime(time.duration - time.current)))),
        react.createElement("div", { className: "player__controls" },
            react.createElement("button", { onClick: prevTrack },
                react.createElement("span", { className: "icon-controller-fast-backward" })),
            react.createElement("button", { onClick: togglePlayPause }, isPlaying ? (react.createElement("span", { className: "icon-controller-pause" })) : (react.createElement("span", { className: "icon-controller-play" }))),
            react.createElement("button", { onClick: nextTrack },
                react.createElement("span", { className: "icon-controller-fast-forward" }))),
        react.createElement("div", { className: "player__volume-control" },
            react.createElement("span", { className: "icon-volume-mute" }),
            react.createElement("input", { type: "range", value: volume, min: "0", max: "100", onChange: handleVolumeChange }),
            react.createElement("span", { className: "icon-volume-hight" })),
...
function AlbumTracks({ album }) {
    const [activeTrack, setActiveTrack] = (0,react.useState)(0); // activeTrack — индекс активного трека (по умолчанию 0).
    const [popupText, setPopupText] = (0,react.useState)(false); // popupText — отвечает за показ попапа с текстом трека.
    const [popupPlayer, setPopupPlayer] = (0,react.useState)(false); // popupPlayer — отвечает за показ попапа с аудиоплеером.
    const [bgColor, setBgColor] = (0,react.useState)('rgba(var(--extra-background-color), 0.8)'); // bgColor — цвет фона для попапа с плеером (обновляется через AudioPlayer).
    const { lang } = useLang();
    const { templateData } = useData(lang);
    ...
    function Block({ tracks }) {
        return (react.createElement(react.Fragment, null,
            react.createElement("h2", { className: "album-title" }, album?.album),
            react.createElement("div", { className: "wrapper-album-play" },
                react.createElement("button", { className: "album-play", onClick: openPlayerPopup, type: "button", "aria-label": "\u041A\u043D\u043E\u043F\u043A\u0430 play", "aria-description": "\u041E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442 \u043F\u043B\u0435\u0435\u0440" },
                    react.createElement("span", { className: "icon-controller-play" }),
                    templateData.templateC[0]?.buttons.playButton)),
            react.createElement("div", { className: "tracks" }, tracks?.map((track) => (react.createElement("button", { key: track.id, className: `tracks__btn ${track.id === activeTrack ? 'active' : ''}`, "data-index": track.id, onClick: handleClick, type: "button", "aria-label": "\u041A\u043D\u043E\u043F\u043A\u0430 \u0441 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435\u043C \u043F\u0435\u0441\u043D\u0438", "aria-description": "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0442\u0435\u043A\u0441\u0442 \u043F\u0435\u0441\u043D\u0438" }, track.title)))),
            react.createElement(Popup, { isActive: popupText, onClose: closePopups },
                react.createElement("pre", null, tracks?.[activeTrack]?.content),
                react.createElement(Hamburger, { isActive: popupText, onToggle: closePopups })),
            popupPlayer && (react.createElement(Popup, { isActive: popupPlayer, bgColor: bgColor, onClose: closePopups },
                album && (react.createElement(AudioPlayer, { album: album, setBgColor: setBgColor, autoPlay: true })),
                react.createElement(Hamburger, { isActive: popupPlayer, onToggle: closePopups })))));
    }
    return react.createElement(Block, { ...album });
}
...
function Share() {
    const [share, setShare] = (0,react.useState)(false);
    function handleClick(e) {
        e.preventDefault();
        setShare(!share);
    }
    function handleShareClick(platform, uri) {
        if (uri === 'this') {
    ...
    function popUpWindow(mypage, myname, w, h, scroll, pos) {
        ...
        const settings = `width=${w},height=${h},top=${TopPosition},left=${LeftPosition},scrollbars=${scroll},` +
            `location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no`;
        window.open(mypage, myname, settings);
    }
    return (react.createElement("ul", { className: "share-list js-share-item" },
        react.createElement("li", { className: "share-list__item", onClick: handleClick },
            react.createElement("a", { className: `share-list__link icon-share ${share ? 'active' : ''}`, href: "#", title: "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F" })),
        react.createElement("li", { className: `share-list__item ${share ? 'show' : ''}` },
            react.createElement("a", { className: "share-list__link icon-facebook1", href: "#", title: "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F \u043D\u0430 Facebook", onClick: () => handleShareClick('facebook', 'this') })),
        react.createElement("li", { className: `share-list__item ${share ? 'show' : ''}` },
            react.createElement("a", { className: "share-list__link icon-twitter", href: "#", title: "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F \u043D\u0430 Twitter", onClick: () => handleShareClick('twitter', 'this') }))));
}
...
function GetButton({ buttonClass, buttonUrl, buttonText, }) {
    return (react.createElement("li", { className: "service-buttons__list-item" },
        react.createElement("a", { className: `service-buttons__link ${buttonClass}`, href: buttonUrl, target: "_blank" },
            react.createElement("span", { className: "visually-hidden" }, buttonText))));
}

;// ./src/components/ServiceButtons/ServiceButtons.tsx
 ...
 */
function ServiceButtonsPurchase({ album, section, }) {
    /**
     * Компонент отображает блок с кнопками-ссылками на агрегаторы.
     */
    function Block({ purchase, stream, itunes, bandcamp, amazon, apple, vk, youtube, spotify, yandex, deezer, tidal, }) {
        const { lang } = useLang();
        const { templateData } = useData(lang);
        return (react.createElement("div", { className: "service-buttons" },
            section === 'Купить' && (react.createElement(react.Fragment, null,
                react.createElement("h3", null, templateData.templateC[0]?.buttons.purchase),
                react.createElement("ul", { className: "service-buttons__list", "aria-label": "\u0411\u043B\u043E\u043A \u0441\u043E \u0441\u0441\u044B\u043B\u043A\u0430\u043C\u0438 \u043D\u0430 \u043F\u043B\u0430\u0442\u043D\u044B\u0435 \u043C\u0443\u0437\u044B\u043A\u0430\u043B\u044C\u043D\u044B\u0435 \u0430\u0433\u0440\u0435\u0433\u0430\u0442\u043E\u0440\u044B" },
                    react.createElement(GetButton, { buttonClass: "icon-applemusic", buttonUrl: itunes, buttonText: "iTunes" }),
                    react.createElement(GetButton, { buttonClass: "icon-bandcamp", buttonUrl: bandcamp, buttonText: "Bandcamp" }),
                    react.createElement(GetButton, { buttonClass: "icon-amazon", buttonUrl: amazon, buttonText: "Amazon" })))),
            section === 'Слушать' && (react.createElement(react.Fragment, null,
                react.createElement("h3", null, templateData.templateC[0]?.buttons.stream),
                react.createElement("ul", { className: "service-buttons__list", "aria-label": "\u0411\u043B\u043E\u043A \u0441\u043E \u0441\u0441\u044B\u043B\u043A\u0430\u043C\u0438 \u043D\u0430 \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u044B\u0435 \u043C\u0443\u0437\u044B\u043A\u0430\u043B\u044C\u043D\u044B\u0435 \u0430\u0433\u0440\u0435\u0433\u0430\u0442\u043E\u0440\u044B" },
                    react.createElement(GetButton, { buttonClass: "icon-apple", buttonUrl: apple, buttonText: "Apple music" }),
                    react.createElement(GetButton, { buttonClass: "icon-vk", buttonUrl: vk, buttonText: "\u0412\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u0435" }),
                    react.createElement(GetButton, { buttonClass: "icon-youtube1", buttonUrl: youtube, buttonText: "YouTube" }),
                    react.createElement(GetButton, { buttonClass: "icon-spotify", buttonUrl: spotify, buttonText: "YoSpotifyuTube" }),
                    react.createElement(GetButton, { buttonClass: "icon-yandex", buttonUrl: yandex, buttonText: "Yandex" }),
                    react.createElement(GetButton, { buttonClass: "icon-deezer", buttonUrl: deezer, buttonText: "Deezer" }),
                    react.createElement(GetButton, { buttonClass: "icon-tidal", buttonUrl: tidal, buttonText: "Tidal" }))))));
    }
    // оператор расширения или распространения (spread-оператор) ...
    return react.createElement(Block, { ...album?.buttons });
}

;// ./src/components/Albums/Album.tsx
...
function Album() {
    ...
    return (react.createElement("section", { className: "album main-background", "aria-label": "\u0411\u043B\u043E\u043A c \u0430\u043B\u044C\u0431\u043E\u043C\u043E\u043C" },
        react.createElement("div", { className: "wrapper album__wrapper" },
            react.createElement("nav", { className: "breadcrumb item-type-a", "aria-label": "Breadcrumb" },
                react.createElement("ul", null,
                    react.createElement("li", null,
                        react.createElement(Link, { to: "/albums" }, templateData.templateC[0]?.titles.albums)),
                    react.createElement("li", { className: "active" }, album?.album))),
            loading && react.createElement(Loader, null),
            error && react.createElement(ErrorMessage, { error: error }),
            react.createElement("div", { className: "item" },
                react.createElement(AlbumCover, { ...album?.cover, fullName: album?.fullName }),
            ...
            react.createElement("div", { className: "item" },
                react.createElement(AlbumTracks, { album: album })),
            react.createElement("div", { className: "item" },
                react.createElement(ServiceButtonsPurchase, { album: album, section: "\u041A\u0443\u043F\u0438\u0442\u044C" })),
            react.createElement("div", { className: "item" },
                react.createElement(ServiceButtonsPurchase, { album: album, section: "\u0421\u043B\u0443\u0448\u0430\u0442\u044C" }))),
        react.createElement(AlbumDetails, { album: album })));
}
...
function NotFoundPage() {
    ...
    return (react.createElement("section", { className: "not-found main-background" },
        react.createElement("h2", null, "\u0421\u0442\u0440\u0430\u043D\u0438\u0446\u0430 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u0430"),
        react.createElement("button", { onClick: () => navigate('/') }, "\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043D\u0430 \u0433\u043B\u0430\u0432\u043D\u0443\u044E")));
}
...
function Form_Form() {
    return (react.createElement("section", { className: "form main-background", "aria-label": "\u0411\u043B\u043E\u043A c \u0444\u043E\u0440\u043C\u043E\u0439" },
        react.createElement("div", { className: "wrapper" },
            react.createElement("h2", null, "\u0417\u0430\u044F\u0432\u043A\u0430"),
            react.createElement("form", { id: "new-album", className: "form__wrapper", action: "", method: "POST" },
                react.createElement("label", { className: "item", htmlFor: "artist" }, "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B"),
                react.createElement("input", { className: "input item", id: "artist", type: "text", name: "artist", placeholder: "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B", required: true, autoFocus: true }),
                react.createElement("label", { className: "item", htmlFor: "album" }, "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0430\u043B\u044C\u0431\u043E\u043C\u0430"),
                react.createElement("input", { className: "input item", id: "album", type: "text", name: "album", placeholder: "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0430\u043B\u044C\u0431\u043E\u043C\u0430", required: true }),
                react.createElement("label", { className: "item", htmlFor: "date" }, "\u0414\u0430\u0442\u0430 \u0432\u044B\u0445\u043E\u0434\u0430 \u0430\u043B\u044C\u0431\u043E\u043C\u0430"),
                react.createElement("input", { className: "input item", id: "date", type: "number", name: "date", placeholder: "\u0414\u0430\u0442\u0430", required: true }),
                react.createElement("label", { className: "item", htmlFor: "cover" }, "\u041E\u0431\u043B\u043E\u0436\u043A\u0430 \u0430\u043B\u044C\u0431\u043E\u043C\u0430"),
                react.createElement("input", { className: "file-selector item", id: "cover", type: "file", accept: "image/jpeg", name: "date", required: true }),
                react.createElement("fieldset", null,
                    react.createElement("label", null,
                        react.createElement("input", { className: "visually-hidden", type: "radio", name: "answer" }),
                ...
                react.createElement("fieldset", null,
                    react.createElement("label", null,
                        react.createElement("input", { className: "visually-hidden", type: "checkbox", name: "music-style" }),
                        react.createElement("span", null),
                        "Punk"),
                    react.createElement("label", null,
                        react.createElement("input", { className: "visually-hidden", type: "checkbox", name: "music-style" }),
                ...
                react.createElement("fieldset", null,
                    react.createElement("div", { className: "select-container" },
                        react.createElement("select", { name: "cartoon" },
                            react.createElement("option", { value: "" }, "\u0418\u0441\u0442\u043E\u0440\u0438\u044F \u0438\u0433\u0440\u0443\u0448\u0435\u043A"),
                            react.createElement("option", { value: "" }, "\u041C\u0443\u043B\u0430\u043D"),
                            react.createElement("option", { value: "" }, "\u041A\u043E\u0440\u043E\u043B\u044C \u041B\u0435\u0432")))),
                react.createElement("fieldset", null,
                    react.createElement("div", { className: "select-container" },
                        react.createElement("select", { name: "cartoon" },
                            react.createElement("option", { value: "" }, "\u0418\u0441\u0442\u043E\u0440\u0438\u044F \u0438\u0433\u0440\u0443\u0448\u0435\u043A"),
                            react.createElement("option", { value: "" }, "\u041C\u0443\u043B\u0430\u043D"),
                            react.createElement("option", { value: "" }, "\u041A\u043E\u0440\u043E\u043B\u044C \u041B\u0435\u0432")))),
                react.createElement("input", { type: "range", min: "20", max: "50", step: "10" }),
                react.createElement("p", null,
                    "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435: ",
                    react.createElement("span", null, "15")),
                react.createElement("button", { className: "item-type-a", type: "submit" }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443")))));
}
...
function Hero() {
    const [backgroundImage, setBackgroundImage] = (0,react.useState)('');
    const location = dist_useLocation(); // Хук для отслеживания изменений URL
    (0,react.useEffect)(() => {
    ...
    return (react.createElement("section", { className: "hero", style: { backgroundImage } },
        react.createElement("h1", { className: "hero__title" }, "C\u043C\u043E\u043B\u044F\u043D\u043E\u0435 \u0447\u0443\u0447\u0435\u043B\u043A\u043E")));
}
...
const router = createBrowserRouter([
    {
        ...
        errorElement: react.createElement(NotFoundPage, null),
        children: [
            {
                index: true,
                element: react.createElement(Albums, null),
            },
            {
                path: '/albums',
                element: react.createElement(Albums, null),
            ...
            {
                path: '/albums/:albumId',
                element: react.createElement(Album, null),
            },
            {
                path: '/aboutus/',
            ...
            {
                path: '/articles',
                element: react.createElement(Articles, null),
            },
            {
                path: '/articles/:articleId',
                element: react.createElement(Article, null),
            },
            {
                path: '/forms',
                element: react.createElement(Form_Form, null),
            },
        ],
    },
]);
function App() {
    return (react.createElement(dist_RouterProvider, { router: router, fallbackElement: react.createElement("p", null, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...") }));
}
function Layout() {
    const [popup, setPopup] = (0,react.useState)(false);
    return (react.createElement(react.Fragment, null,
        react.createElement(Header, null),
        react.createElement("main", null,
            react.createElement(Hero, null),
            react.createElement(Popup, { isActive: popup, onClose: () => setPopup(false) },
                react.createElement(Navigation, { onToggle: () => setPopup(!popup) })),
            react.createElement(Hamburger, { isActive: popup, onToggle: () => setPopup(!popup), zIndex: "1000" }),
...
client.createRoot(document.getElementById('root')).render(react.createElement(react.StrictMode, null,
