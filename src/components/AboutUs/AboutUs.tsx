      ...
      <div className="row">
        <div className="small-12 column">
          ...
          <p className={activeIndex ? "active" : ""}>
            ...
            . Музыкант выпустил два альбома в формате самиздата в жанре
            гранж:&nbsp;
            <Link to="/albums/smolyanoechuchelko">Смоляное чучелко</Link> в 2020
            году и <Link to="/albums/23">23</Link> в 2022 году.
            Название "Смоляное чучелко" образовано от&nbsp;американского термина
